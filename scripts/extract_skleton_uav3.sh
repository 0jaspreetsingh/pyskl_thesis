...
srun -K\
  ...
  --container-image=/netscratch/jsingh/pyskl2.sqsh \
  --container-workdir="`pwd`" \
  scripts/install3.sh python tools/data/custom_2d_skeleton.py --video-list /netscratch/jsingh/thesis/datasets/AUTHUAVGestureDatasetVideos_fps-15/uav_dfki_dataset.list --out /netscratch/jsingh/thesis/datasets/AUTHUAVGestureDatasetVideos_fps-15/uavgesture_annos.pkl --non-dist
