...
ann_file = '/netscratch/jsingh/thesis_dataset/full_dataset/skletons/splits/pyskl/P11_annotations.pkl'
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_ntu60_xsub/limb_p11'
